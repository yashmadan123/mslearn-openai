...
5. On **openai-<inject key="DeploymentID" enableCopy="false"/>** blade, select **Keys and Endpoint (1)** under **Resource Management**. Copy **Key 1 (2)** and the **Language APIs (3)** endpoint by clicking on copy to clipboard option. Paste it in a text editor such as notepad for later use.
